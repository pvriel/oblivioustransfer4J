...
/**
 * Interface representing the senders from the oblivious transfer extension protocols.
 */
public interface ObliviousTransferExtensionSender {
     ...
     *        <br>This stream will not be closed after invoking this method.
     * @throws IOException
     *         If something went wrong during the communication with the {@link ObliviousTransferExtensionReceiver}.
     */
